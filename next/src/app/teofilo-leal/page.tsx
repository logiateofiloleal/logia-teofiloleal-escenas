...
import BackToHomeButton from '../../components/SecondaryLayout/BackToHomeButton';
    ...
    <SecondaryLayout>
      ...
      <div className={styles.hero}>
        <div className={styles.heroInner}>
          ...
          <h1 className={styles.heroTitle}>Teófilo Leal Berra</h1>
      ...
      <div className={styles.portrait} aria-label="Cuadro conmemorativo de Teófilo Leal Berra">
        <Image
          ...
          loading="eager"
        />
        <p className={styles.portraitCaption}>Cuadro conmemorativo · Logia Teófilo Leal N° 115</p>
      </div>
      ...
      <main>
        <div className={styles.contentWrap}>
          ...
          {/* I. Reseña histórica */}
          <section className={styles.section} aria-labelledby="bio-heading-resena">
            <span className={styles.sectionLabel}>Reseña histórica</span>
            <h2 className={styles.sectionTitle} id="bio-heading-resena">Vida y trayectoria</h2>
            <div className={styles.bioRule} aria-hidden="true" />
            ...
            <div className={styles.body}>
              ...
              <p>
                ...
                <em>"Consuelos"</em> una de sus composiciones más conocidas—, periodista, músico
                y pintor. Entre sus aportes se encuentran la creación de la ópera{' '}
                <em>Guaicaipuro</em> y la fundación de periódicos como <em>El Imparcial</em>.
              </p>
              <p>
          ...
          {/* II. Fundación de la Logia */}
          <section className={styles.section} aria-labelledby="bio-heading-logia">
            <span className={styles.sectionLabel}>Fundación · 1949</span>
            <h2 className={styles.sectionTitle} id="bio-heading-logia">La Logia que lleva su nombre</h2>
            <div className={styles.bioRule} aria-hidden="true" />

            <div className={styles.body}>
              <p>
                En honor a sus virtudes y legado, el <strong>21 de febrero de 1949</strong> un grupo
                de hermanos masones decidió fundar en Barquisimeto la Respetable Logia "Teófilo Leal"
          ...
          <div className={styles.actions}>
            <p className={styles.fuente}>
              Fuente: <em>Venciclopedia</em> — Teófilo Leal
            </p>

            <BackToHomeButton
              className={styles.btnSecondary}
              lnClassName={styles.ln}
            />
          </div>
